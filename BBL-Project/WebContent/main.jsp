...
<body>
<!--C:\Users\hb03-30\Documents\GitHub\Bitcamp\JSP\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\BBL-Project-->
<!----------------- 네비게이션  시작-------------------->
...
<!----------------- 네비게이션  끝------------------------>
	...
	<span style="margin:0 auto;font-family: 'Monoton', cursive;font-size:80px;">welcome  to  the  Pulle!</span>
	<div class="mainContents" style="position: relative;">        
        <img src="img/main5.jpg" style="width:1100px;height:600px; margin:0 auto;">
        <span><h1 style="display: inline-block; font-family: 'Black Han Sans', sans-serif; margin:0 80px; font-size:140px;">어디서 뭘먹지?</h1></span>
