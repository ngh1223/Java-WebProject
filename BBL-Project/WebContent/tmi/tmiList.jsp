...
<body>
	...
	<br>
	<a href="tmiForm.jsp" id="make" class="aTag" title="글 작성">일상을 전달해 볼까요?</a>
	<br>
	<br>
	<a href="searchMap.jsp" id="map" class="aTag" title="지도">어디에 뭐가 있는지 궁금하세요?</a>
		...
		<div id="main">
			...
			%>
			<div id="update">
				<a href="updateForm.jsp?tmi_ID=<%=tmi.getTmi_ID()%>" class="aTag" title="수정">새로운 기억이 떠올랐어요!</a><br>
				<a href="deleteForm.jsp?tmi_ID=<%=tmi.getTmi_ID()%>" class="aTag" title="삭제">이 글이 보기 싫어요...</a>
			</div>
		</div>
		<%
				}
